...
class Book extends StatelessWidget {
  ...
  Widget _bookDescription(){
    return Container(
      ...
      child: Text(book['description'], style: BodyPrimaryText,),
    );
  }
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Text('Contents', style: TitleBackgroundText,)
        ),
        Expanded(
          child: ListView(
            shrinkWrap: true,
            ...
            children: contents.map((content) => _content(context, content)).toList()
          ),
        )
      ],
    );
